# -*- encoding: utf-8 -*-
# stub: blacklight 7.4.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rails>.freeze, ["< 7", ">= 5.1"])
      ...
      s.add_development_dependency(%q<rsolr>.freeze, ["< 3", ">= 1.0.6"])
      ...
      s.add_dependency(%q<rails>.freeze, ["< 7", ">= 5.1"])
      s.add_dependency(%q<globalid>.freeze, [">= 0"])
      s.add_dependency(%q<jbuilder>.freeze, ["~> 2.7"])
